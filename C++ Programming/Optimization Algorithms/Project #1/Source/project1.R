...
num_arguments = 7 # number of command line arguments to be expected
...
compile_cmd = "g++ main.cpp matrix.cpp functions.cpp utilities.cpp" #command to compile c++ code
run_cmd = paste("./a.out", num_arguments, sample_size, num_dimensions, delimiter, dimensions_string, num_functions, ranges_string, sep= " ") #command to run the c++ code
