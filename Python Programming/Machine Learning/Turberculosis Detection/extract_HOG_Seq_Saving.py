...
def extract_HOG_features(train_path, valid_path):
    ...
    v_s = Path(valid_path + "Validation_Set.npy")
    v_t_s = Path(valid_path + "Validation_Target_Set.npy")
    t_s = Path(train_path + "Training_Set.npy")
    t_t_s = Path(train_path + "Training_target_Set.npy")
