...
#        print("here")a
    ...
    model.add(Conv2D(64, kernel_size=3, activation='relu', input_shape=(X_train[0].shape[0], X_train[0].shape[1])))
...
def API():
    China_path = "/media/hermann/Tonpi/tonpi/Collegecourses/CWU/Graduate-School/Thesis/Data Sets/CHINA_dataset/Clean_Segmented/"
    MC_path = "/media/hermann/Tonpi/tonpi/Collegecourses/CWU/Graduate-School/Thesis/Data Sets/MC_imgs/MC_clean_seg_imgs/"
    ...
    X_train, y_train = load_data(China_path)
    X_test, y_test = load_data(MC_path)
...
#    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.33, random_state=42)
    ...
    KNN(X_train, y_train, X_test, y_test, path_2, "knn_3_us_norm.pkl", 10)
    MLP(X_train, y_train, X_test, y_test, path_2, "mlp_(5,)_us_norm.pkl",  (1000, 750, ))
    MLP_Keras(X_train, y_train, X_test, y_test, path_2, "mlp_(5,)_us_norm.pkl",  (1000, 750, 1), 200, 1000)
#    CNN_Keras(X_train, y_train, X_test, y_test, path_2, "cnn_(5,)_us_norm.pkl", 200, 1000)
    SVM(X_train, y_train, X_test, y_test, path_2, "svm_300_us_norm.pkl")
    RF(X_train, y_train, X_test, y_test, path_2, "rf_300_us_norm.pkl", 1000)  
