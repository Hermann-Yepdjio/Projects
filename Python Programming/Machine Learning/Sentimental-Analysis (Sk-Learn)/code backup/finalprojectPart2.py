...
#----------remove stop words and then vectorize the data, then train--------
...
#------------- Normalization: stemming, then vectorize, then train, then test-------
#very slow: Final Accuracy: 0.87736
...
#------ Normalization: Lemmantization, then vectorize, then train, then test-------
#faster than stemming, Final Accuracy: 0.87376
...
#-------------n-grams vectorizer, then train, then test----
...
#---------- word count vectorizer, then train, then test-----
...
#------ TF-IDF vectorizer, then train, then test-----
...
#----final model: few stop words + ngram vectorizer + SVM----
# Final Accuracy: 0.9
from sklearn.feature_extraction.text import CountVectorizer
from sklearn.model_selection import train_test_split
from sklearn.metrics import accuracy_score
...
#-------print top positive and negative--------
