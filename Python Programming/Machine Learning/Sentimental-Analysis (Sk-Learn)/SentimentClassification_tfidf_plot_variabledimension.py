...
plt.legend()
plt.grid()
plt.xlabel("TF-IDF maximum number of feature")
plt.ylabel("Accuracy")
plt.title("TF-IDF Accuracy")
plt.savefig('plot_variable_dimension/tf-idf_accurary_dimension.png', bbox_inches='tight')
...
plt.title("TF-IDF Run time")
plt.savefig('plot_variable_dimension/tf-idf_accurary_runtime.png', bbox_inches='tight')
