...
class OpenGLWidget(QGLWidget):
    ...
    def __init__(self, parent, fname):
        ...
        # self.setWindow(0, 720, 0, 480)
        # self.setViewport(0, int(720), 0, int(480))
        # Current 2d point
    ...
    def drawString2(self, x, y, string):
        ...
        glut.glutBitmapString(glut.GLUT_BITMAP_8_BY_13,
                              bytes(string, 'ascii'))
        gl.glFlush()
    def drawRectangle(self, point1, point2):
        self.moveRel(point1.x(), point1.Y)
        self.lineTo(point1.x(), point2.y())
        self.lintTo(point2.x(), point2.y())
        self.lintTo(point2.x(), point1.y())
        self.lineTo(point1.x(), point1.y())
...
class App(QMainWindow):
    ...
    def mouseReleaseEvent(self, QMouseEvent):
        ...
        # print(QMouseEvent.x(), ", ", QMouseEvent.y())
        #self.drawRectangle(point1, point2)
        return QMouseEvent
